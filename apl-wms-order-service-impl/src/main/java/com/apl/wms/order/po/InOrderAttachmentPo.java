...
@TableName("in_order_attachment")
@ApiModel(value="入库订单其他信息 持久化对象", description="入库订单其他信息 持久化对象")
public class InOrderAttachmentPo extends Model<InOrderAttachmentPo> {
    ...
    @NotNull(message = "入库-运费不能为空")
    @Min(value = 0 , message = "入库-运费不合法")
