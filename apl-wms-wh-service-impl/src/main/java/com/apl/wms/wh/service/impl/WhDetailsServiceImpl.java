...
import com.apl.wms.wh.vo.WhDetailsInfoVo;
...
public class WhDetailsServiceImpl extends ServiceImpl<WhDetailsMapper, WhDetailsPo> implements WhDetailsService {
    ...
    @Override
    public ResultUtils<WhDetailsInfoVo> selectById(Integer id){

        WhDetailsInfoVo whDetailsInfoVo = baseMapper.getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, whDetailsInfoVo);
    }
