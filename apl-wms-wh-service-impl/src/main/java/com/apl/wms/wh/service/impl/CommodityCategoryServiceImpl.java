...
public class CommodityCategoryServiceImpl extends ServiceImpl<CommodityCategoryMapper, CommodityCategoryPo> implements CommodityCategoryService {
    ...
    @Override
    public ResultUtils<CommodityCategoryPo> selectById(Long id){

        CommodityCategoryPo commodityCategory = getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, commodityCategory);
    }
