...
public class StorageCommodityServiceImpl extends ServiceImpl<StorageCommodityMapper, StorageCommodityPo> implements StorageCommodityService {
    ...
    @Override
    public ResultUtils<StorageCommodityInfoVo> selectById(Integer id){

        StorageCommodityInfoVo storageCommodityInfoVo = baseMapper.getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, storageCommodityInfoVo);
    }
