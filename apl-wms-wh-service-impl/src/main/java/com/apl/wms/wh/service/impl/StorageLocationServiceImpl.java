...
public class StorageLocationServiceImpl extends ServiceImpl<StorageLocationMapper, StorageLocationPo> implements StorageLocationService {
    ...
    @Override
    public ResultUtils<StorageLocationPo> selectById(Long id){

        StorageLocationPo storageLocation = getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, storageLocation);
    }
