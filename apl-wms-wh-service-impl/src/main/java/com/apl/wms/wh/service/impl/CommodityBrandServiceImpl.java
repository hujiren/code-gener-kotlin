...
public class CommodityBrandServiceImpl extends ServiceImpl<CommodityBrandMapper, CommodityBrandPo> implements CommodityBrandService {
    ...
    @Override
    public ResultUtils<CommodityBrandPo> selectById(Long id){

        CommodityBrandPo commodityBrand = getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, commodityBrand);
    }
