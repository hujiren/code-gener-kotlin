...
public class GoodsBacketServiceImpl extends ServiceImpl<GoodsBacketMapper, GoodsBacketPo> implements GoodsBacketService {
    ...
    @Override
    public ResultUtils<GoodsBacketPo> selectById(Long id){

        GoodsBacketPo goodsBacket = getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, goodsBacket);
    }
