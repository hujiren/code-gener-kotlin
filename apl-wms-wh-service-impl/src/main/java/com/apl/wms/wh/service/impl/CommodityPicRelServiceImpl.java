...
public class CommodityPicRelServiceImpl extends ServiceImpl<CommodityPicRelMapper, CommodityPicRelPo> implements CommodityPicRelService {
    ...
    @Override
    public ResultUtils<CommodityPicRelInfoVo> selectById(Integer id){

        CommodityPicRelInfoVo commodityPicRelInfoVo = baseMapper.getById(id);

        return ResultUtils.APPRESULT(CommonStatusCode.GET_SUCCESS, commodityPicRelInfoVo);
    }
